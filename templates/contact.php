        ...
        <div class="preliminar_int">
            <div class="preliminar-detalle" id="ancho1">
                <div class="ancho1-caja">
                    ...
                    <p class="span-none">correo@gmail.com</p>
                </div>
                <div class="ancho1-caja">
                    <p>|</p>
                </div>
                <div class="ancho1-caja">
                    ...
                    <span class="span-none">+01 304 241 88 63</span>
                </div>
            </div>
            <div class="preliminar-detalle">
                <div class="flex-flex">
                    <div>
                        <a target="_blank" href="https://www.instagram.com/solida360_?igsh=MWFlZW9iaTJ0N3NuMQ%3D%3D"><img class="redes" src="../front-end/img/iconos/ig-3000.png" alt=""></a>
                    </div>
                    <div>
                        <a target="_blank" href="https://www.facebook.com/?locale=es_LA"><img class="redes" src="../front-end/img/iconos/3000.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="header">
        <div class="header_flex">
            <div class="logo_box">
                ...
                <script src="../front-end/js/duluth.js"></script>
            </div>
    ...
    <section class="home">
        <div class="info-letras" data-aos="fade-down">
            <div class="letras-int">
                <h1 class="duluth2">CONTACT US</h1>
            </div>
        </div>
    </section>
        ...
        <div class="fotter-flex"> 
            <div class="fot_int">
                <div class="mini_about" id="rightpos"> 
                    <a href="index.html">
                        <img id="about_img" src="../front-end/img/iconos/logo.jpg" alt="">
                    </a>
                </div>
            </div>
            <div class="fot_int">
                ...
                <div class="mini_contact">
                    ...
                    <div class="boxi">
                        <div class="info_contact_fot">
                            ...
                            <p>+01 123 456 78 99</p>
                        </div>
                        <div class="info_contact_fot">
                            <img class="icon_fot" src="../front-end/img/iconos/ubi.png" alt="">
                            <p>3105 Peachtree Industrial Blvd. Duluth, GA 30097</p>
                        </div>
                        <div class="info_contact_fot">
...
if (isset($_POST["enviar"])) {
    ...
    $content = "Messaje from the website of: $name \n";
    $content .= "Email: $email \n";
